"""
===================================================================================
Title: Module 9.2 Milestone 2: Display Database Data
Original Author: Trenten Coffman, Wade Eckert
Date Modified: 22 February 2026
Description: This script connects to the MySQL database and retrieves all records 
from the employees, clients, accounts, assets, holdings, and transactions tables. 
The retrieved data is printed to the console in a readable format. The script also 
includes error handling for database connection issues and ensures that the database 
